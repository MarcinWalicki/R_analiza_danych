...
Kendall[1] <-0
Kendall[2] <-0
plot(1:32,Spearman,col="blue",type="l",ylim=c(-1.1,1.1), xlab="Liczba krajów z czo³ówki wziêta pod uwagê",
     ylab="Wsp. korelacji")
...
vector_odrz_S_2 <- rep(0,32)
vector_odrz_K_2 <- rep(0,32)
for (j in 3:32){
...
lines(1:32,vector_odrz_S_2,col="red",type="l")
lines(1:32,vector_odrz_K_2,col="black",type="l")

legend("topright",col=c("blue","green","red","black"),legend=c("Spearman","Kendall"
     ,"funkcja krytyczna Spearman","funkcja krytyczna Kendall"),pch=15, cex=0.8)
